...
class _CategoriaListaPageState extends State<CategoriaListaPage> {
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: const InputDecoration(
            ...
            hintStyle: TextStyle(color: AppColors.textoClaro),
            prefixIcon: Icon(Icons.search, color: AppColors.textoClaro),
  ...
  Widget _buildChip(String label, _FiltroStatus status, IconData icone) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selecionado ? AppColors.laranja : Colors.white,
          borderRadius: BorderRadius.circular(30),
          boxShadow: [
            BoxShadow(
        ...
        child: Row(
          children: [
            Icon(
              icone,
              size: 16,
              color: selecionado ? Colors.white : AppColors.textoClaro,
            ),
        ...
        children: [
          Container(
            ...
            child: Icon(
              ...
              color: ativo ? AppColors.laranja : Colors.grey,
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                Text(
                  categoria.nome,
                  style: TextStyle(
                    color: ativo ? AppColors.textoEscuro : Colors.grey,
                    fontWeight: FontWeight.bold,
                    fontSize: 15,
                  ),
                ),
  ...
  Widget _buildMenuAcoes(CategoriaDto categoria) {
    ...
    return PopupMenuButton<String>(
      icon: const Icon(Icons.more_vert, color: AppColors.textoClaro),
      ...
      itemBuilder: (_) => [
        const PopupMenuItem(
          ...
          child: Row(
            children: [
              Icon(Icons.edit_outlined, size: 18, color: AppColors.textoEscuro),
              SizedBox(width: 10),
              Text('Editar'),
            ],
          ),
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Cancelar', style: TextStyle(color: AppColors.textoEscuro)),
          ),
          ElevatedButton(
