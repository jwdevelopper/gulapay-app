...
import 'package:my_app_teste/modules/mesa/widgets/table_node.dart';
            ...
            return ClipRRect(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: AppTema.canvasMapa,
                  borderRadius: BorderRadius.circular(widget.borderRadius),
                  border: widget.borderRadius == 0
                      ? null
                      : Border.all(color: AppTema.borda),
                ),
                child: Stack(
                  children: [
                    Positioned.fill(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppTema.primaria),
        boxShadow: [
          BoxShadow(
  ...
  Widget build(BuildContext context) {
    return IgnorePointer(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppTema.superficieAlt.withValues(alpha: 0.94),
          borderRadius: BorderRadius.circular(18),
    ...
    return Tooltip(
      ...
      child: IconButton(
        ...
        style: IconButton.styleFrom(
          backgroundColor: isActive ? AppTema.primaria : Colors.transparent,
          foregroundColor: isActive ? Colors.white : AppTema.texto,
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.link, size: 18, color: AppTema.primaria),
            const SizedBox(width: 8),
            const Flexible(
              child: Text(
...
class _RestaurantFloorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final basePaint = Paint()..color = AppTema.canvasMapa;
  ...
  void _drawFloorTexture(Canvas canvas, Size size) {
    ...
    final linePaint = Paint()
      ..color = AppTema.bordaSuave.withValues(alpha: 0.45)
      ..strokeWidth = 1;
  ...
  void _drawGrid(Canvas canvas, Size size) {
    final fineLine = Paint()
      ..color = AppTema.bordaSuave.withValues(alpha: 0.5)
      ..strokeWidth = 1;
  ...
  void _drawWalls(Canvas canvas, Size size) {
    final wallPaint = Paint()
      ..color = AppTema.texto.withValues(alpha: 0.22)
  ...
  void _drawAreaFixtures(Canvas canvas, Size size) {
    final counterColor = AppTema.textoSecundario.withValues(alpha: 0.18);
  ...
  void _drawFixture(
    ...
    final borderPaint = Paint()
      ..color = AppTema.borda.withValues(alpha: 0.85)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1.2;
