          ...
          child: InkWell(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isSelected ? AppTema.primaria : AppTema.superficie,
                borderRadius: BorderRadius.circular(18),
                border: Border.all(
                  color: isSelected ? AppTema.primaria : AppTema.borda,
                ),
                boxShadow: [
                  BoxShadow(
                ...
                children: [
                  Container(
                    ...
                    child: Icon(
                      _areaIcon(area.type),
                      size: iconSize,
                      color: isSelected ? Colors.white : AppTema.texto,
                    ),
                  ),
                        ...
                        ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation<Color>(
                              isSelected ? Colors.white : AppTema.primaria,
                            ),
                          ),
                        ),
                        SizedBox(height: compact ? 4 : 5),
