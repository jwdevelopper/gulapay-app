  ...
  BoxDecoration _buildDecoration() {
    ...
    if (table.shape == TableShape.round) {
      return BoxDecoration(
        ...
        shape: BoxShape.circle,
        border: Border.all(
          color: isSuggestedJoin ? AppTema.primaria : AppTema.borda,
...
class _NodeStatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTema.superficieAlt.withValues(alpha: 0.76),
        borderRadius: BorderRadius.circular(999),
        border: Border.all(color: AppTema.borda.withValues(alpha: 0.8)),
      ),
